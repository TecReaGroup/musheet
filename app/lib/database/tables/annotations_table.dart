...
class Annotations extends Table {
  ...
  // Note: Per APP_SYNC_LOGIC.md §2.1.1, Annotation is a local cache table only.
  // It doesn't participate in sync independently - annotations are embedded
  // in InstrumentScore.annotationsJson for sync purposes.
  // Therefore, no sync fields (serverId, syncStatus, version) are needed.
