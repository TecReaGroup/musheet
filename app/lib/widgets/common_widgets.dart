...
import 'package:musheet_shared_ui/musheet_shared_ui.dart' as msu;
...
/// )
/// ```
class GradientIconBox extends msu.GradientIconBox {
...
class AvatarIcon extends msu.AvatarIcon {
  const AvatarIcon({
    super.key,
