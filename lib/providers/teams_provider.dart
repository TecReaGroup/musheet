    ...
    if (scores.isNotEmpty && setlists.isNotEmpty) {
      return [
        TeamData(
          ...
          members: [
            TeamMember(id: '1', name: 'You', username: 'you', role: 'admin'),
            TeamMember(id: '2', name: 'John Smith', username: 'john', role: 'member'),
            TeamMember(id: '3', name: 'Sarah Chen', username: 'sarah', role: 'admin'),
          ],
        ...
        TeamData(
          ...
          members: [
            TeamMember(id: '1', name: 'You', username: 'you', role: 'admin'),
            TeamMember(id: '4', name: 'Emma Wilson', username: 'emma', role: 'member'),
          ],
        ...
        TeamData(
          ...
          name: 'Jazz Quartet',
          members: [
            TeamMember(id: '1', name: 'You', username: 'you', role: 'member'),
            TeamMember(id: '5', name: 'Mike Johnson', username: 'mike', role: 'admin'),
            TeamMember(id: '6', name: 'Lisa Brown', username: 'lisa', role: 'member'),
          ],
